...
export class StringUtils {
    static generateRandomUserData(): memberData {
        ...
        const emailList: string[] = ['petru@tech.io', 'Ioana@tech.io', 'ana@tech.io', 'vektor@tech.io']
        ...
        const newEmailList: string[] = ['petru@tech1.io', 'Ioana@tech1.io', 'ana@tech1.io', 'vektor@tech1.io']
